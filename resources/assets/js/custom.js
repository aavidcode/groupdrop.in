                    ...
                    if (resp.accessGranted == false) {
                        ...
                        if (!resp.is_activate) {
                            bootbox.alert({
                                ...
                                message: "An email has been sent to you. Please activate your account by clicking on the link in the email.",
                                className: "warning"
                            });
                        } else if (!resp.is_community) {
